...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#050816] overflow-hidden relative p-4 md:p-8 font-sans">
      ...
      <div className="relative z-10 w-full max-w-[460px] bg-[#0B1220]/50 backdrop-blur-2xl border border-white/[0.07] rounded-2xl p-8 md:p-10 shadow-[0_25px_60px_rgba(0,0,0,0.6)] overflow-hidden group">
        ...
        {/* Role Selector Tabs */}
        <div 
          className="h-11 rounded-full bg-white/[0.03] border border-white/[0.06] flex items-center p-[3px] gap-[2px] mb-6"
