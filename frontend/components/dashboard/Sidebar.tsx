...
import { LayoutDashboard, Mail, MapPinned, User, LogOut } from "lucide-react";
...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-60 border-r border-[var(--border)] bg-[var(--surface)] flex flex-col z-40">
      {/* Logo */}
