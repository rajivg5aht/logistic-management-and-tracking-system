    ...
    <div className="bg-white border border-[#E2E8F0] rounded-xl p-6 shadow-sm">
      ...
      <div className="overflow-hidden rounded-lg shadow-sm border border-[#E2E8F0] relative h-[105px]">
        <svg className="w-full h-full" viewBox="0 0 200 105" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M 5 15 Q 12 8, 20 18 T 35 15 T 45 30 T 30 50 T 20 40 Z" fill="#E2D7C4" opacity="0.85" />
          <path d="M 60 25 Q 75 18, 90 28 T 105 15 T 120 30 T 110 55 T 85 45 Z" fill="#E2D7C4" opacity="0.85" />
          <path d="M 130 15 Q 145 10, 160 22 T 180 15 T 195 30 T 175 60 T 150 40 Z" fill="#E2D7C4" opacity="0.85" />
          <path d="M 25 55 Q 35 62, 30 75 T 45 85 T 35 100 T 15 90 T 10 70 Z" fill="#E2D7C4" opacity="0.85" />
          <path d="M 125 55 Q 140 60, 135 80 T 150 95 T 130 102 T 115 80 Z" fill="#E2D7C4" opacity="0.85" />
          <path d="M 45 70 Q 75 50, 95 35" stroke="#1D7A8C" strokeWidth="1.8" strokeDasharray="4 3.5" strokeLinecap="round" opacity="0.9" />
          ...
          <g transform="translate(110, 60)">
            ...
            <path d="M -7 -5 L -2 -3 L 3 -5 L 8 -3 M -8 -1 L -3 1 L 2 -1 L 7 1 M -7 3 L -2 5 L 3 3 L 8 5" stroke="#D5A021" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
          </g>
        </svg>
      </div>
    </div>
