          ...
          <div className="flex items-center gap-3">
            {[
              ...
              <a
                ...
                href="#"
                aria-label={label}
                className="w-9 h-9 flex items-center justify-center rounded-full border border-white/[0.08] text-white/30 hover:border-white/20 hover:text-white/60 transition-colors"
              >
